...
describe("TodoList Component", () => {
  ...
  test("adds a new todo", () => {
    ...
    fireEvent.click(screen.getByText("Add Todo")); // Button text matches the DOM
  ...
  test("does not add an empty todo", () => {
    ...
    expect(screen.queryAllByRole("listitem").length).toBe(2); // Ensure no additional todos are added
  });
