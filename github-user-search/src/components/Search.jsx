...
const Search = () => {
  ...
  const [location, setLocation] = useState("");  // Stores the location input
  const [minRepos, setMinRepos] = useState(0);  // Stores the minimum repositories input
      ...
      <form onSubmit={handleSearch} className="space-y-4">
        ...
        <div>
          ...
          <input
            type="text"
            value={location}
            onChange={(e) => setLocation(e.target.value)}  // Updates the location input
        ...
        <div>
          ...
          <input
            type="number"
            value={minRepos}
            onChange={(e) => setMinRepos(e.target.value)}  // Updates the minimum repos input
